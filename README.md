...
Create a new public GitHub repository and upload the contents of this folder so `app.py`, `requirements.txt`, and the `finguard/` folder are at the repository root. In Streamlit Cloud choose:

- Repository: your new GitHub repository
- Branch: `main`
- Main file path: `app.py`

Click **Deploy**. Streamlit Cloud installs the packages from `requirements.txt` automatically. Do not upload `.venv/` or `__pycache__/`.
